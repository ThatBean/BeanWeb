var image = (function () {
	...
	image.loadFont = function () {
		...
		var font_canvas = B_Toolbox.createElement(document.body, 'canvas', 'B_font_canvas');
		//font_canvas.style = 'display:none;';
		font_canvas.style.display = '';
