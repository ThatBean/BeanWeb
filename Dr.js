...
var Dr = (
    ...
    if (typeof (dr_global.window) !== 'undefined' && typeof (dr_global.document) !== 'undefined') {
        dr_environment = 'browser';
        console.log('detected', dr_environment);
    }

    if (typeof (dr_global.process) !== 'undefined' && typeof (dr_global.process.versions) !== 'undefined' && dr_global.process.versions.node) {
        dr_environment = 'node';
        console.log('detected', dr_environment, dr_global.process.versions.node);
    }

    if (typeof (dr_global.cordova) !== 'undefined') {
    ...
    Dr.ModuleManagerProto = (function () {
        ...
        Module.prototype.load = function (module_name) {
            ...
            var module = module_data.implement_func(
                ...
                });	//packed module_get for access Required module
    ...
    Dr.Declare = function (module_name, module_type) {
        Dr.ModuleManager.declare(module_name, module_type);
    };
    Dr.Require = function (module_name, required_module_name) {
        Dr.ModuleManager.require(module_name, required_module_name);
    };
    Dr.Implement = function (module_name, module_implement_func) {
        Dr.ModuleManager.implement(module_name, module_implement_func);
    };
    Dr.LoadAll = function () {
        Dr.ModuleManager.loadAll();
    };
    Dr.Get = function (module_name) {
        return Dr.ModuleManager.get(module_name);
    };
    Dr.GetNew = function (/* module_name, args for new */) {
        ...
        if (module) {
            function wrapper() {
                return module.apply(this, arg_list);
            };
    ...
    // Check Function & add Fall-back(poly-fill)
    ...
    //time related
    Dr.getUTCTimeStamp = function () {
        return Math.floor(Date.now() / 1000);
    };
    Dr.startTimestamp = Dr.getUTCTimeStamp();
    Dr.startClock = Date.now();
    Dr.clock = function () {
        return (Date.now() - Dr.startClock);
    }; //return running time in milliseconds
    Dr.clockPerSec = 1000;
    Dr.now = function () {
        return (Date.now() - Dr.startClock) / Dr.clockPerSec;
        ...
        switch (Dr.environment) {
            ...
            case 'cordova':
                return function (callback) {
                    Dr.window.requestAnimationFrame(callback);
                };
            case 'node':
                return function (callback) {
    ...
    Dr.toggle = function () {
        Dr.Toggle.toggle.apply(Dr.Toggle, Dr.getArgumentArray(arguments));
    }
            ...
            case 'cordova':
                return function (script_src, callback) {
                    ...
                    script_element.onload = function () {
                        if (callback) callback(script_element);
                    };
